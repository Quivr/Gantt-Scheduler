                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{route('tasks.index')}}">Index</a></li>
                                <li><a href="{{route('tasks.create')}}">Create new task</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Resource<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{route('resources.index')}}">Index</a></li>
